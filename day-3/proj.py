...
if first_turn == "left":
    ...
    if swim == "swim":
        print(f"A sea snake jumps out of the water, his tail whips back. The sudden crack slices through {name}'s arm leaving him gushing blood. Dobbins swam back and escaped to safety as {name} drowned deep into the ocean.")
    else:
        print("As you approach the dock, the boat keeper comes out from the fog. \n Dobbins walks up to him and asks about passage across the river. He gestures you and ")
else:
